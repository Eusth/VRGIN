...
public class SteamVR_ControllerManager : MonoBehaviour
{
	...
	void Awake()
	{
        ...
        Console.WriteLine("Has Left? " + (objects[1] ? " YES" : "NO"));
        Console.WriteLine("Has right? " + (objects[0] ? " YES" : "NO"));
	...
	private void SetTrackedDeviceIndex(int objectIndex, uint trackedDeviceIndex)
	{
        ...
        Console.WriteLine("Only set when changed ({0}, {1})", trackedDeviceIndex, indices[objectIndex]);
		...
		if (trackedDeviceIndex != indices[objectIndex])
		{
			...
			if (obj != null)
			{
                if (trackedDeviceIndex == OpenVR.k_unTrackedDeviceIndexInvalid)
                {
                    Console.WriteLine("New ID is invalid :(");
            ...
            {
                Console.WriteLine("Obj at index {0} is null :(", objectIndex);
            }
		}
	}
