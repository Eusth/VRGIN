...
public class SteamVR_Render : ProtectedBehaviour
{
	...
	void OnDisable()
	{
        ...
        {
        System.Console.WriteLine(frame.GetMethod().DeclaringType.Name + "." + frame.GetMethod().Name);
    ...
    protected override void OnAwake()
	{
		...
		{
   //         System.Console.WriteLine("EXTCAM");
