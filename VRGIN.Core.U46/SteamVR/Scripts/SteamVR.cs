...
public class SteamVR : System.IDisposable
{
	...
	static SteamVR CreateInstance()
	{
		try
		{
			...
			{
#if !(UNITY_5_3 || UNITY_5_2 || UNITY_5_1 || UNITY_5_0 || UNITY_4_5)
				Console.WriteLine("OpenVR initialization failed.  Ensure 'Virtual Reality Supported' is checked in Player Settings, and OpenVR is added to the list of Virtual Reality SDKs.");
				return null;
#else
