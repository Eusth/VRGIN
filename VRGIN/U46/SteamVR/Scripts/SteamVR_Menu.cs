...
public class SteamVR_Menu : MonoBehaviour
{
	...
	public void ShowMenu()
	{
		...
		if (texture == null)
		{
			Console.WriteLine("Menu requires overlay texture to be a render texture.");
			return;
		}
        ...
        PseudoCursor.lockState = CursorLockMode.None;
	...
	{
		savedCursorVisible = PseudoCursor.visible;
		savedCursorLockState = PseudoCursor.lockState;
	}

	void RestoreCursorState()
	{
        PseudoCursor.visible = savedCursorVisible;
        PseudoCursor.lockState = savedCursorLockState;
	}


    static class PseudoCursor
    {
        ...
        static public CursorLockMode lockState
        {
            get
            {
                return Screen.lockCursor ? CursorLockMode.Confined : CursorLockMode.None;
            }
            set
            {
                Screen.lockCursor = value == CursorLockMode.Confined;
            }
        }
    }
