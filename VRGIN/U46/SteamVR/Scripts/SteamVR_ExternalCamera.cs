...
public class SteamVR_ExternalCamera : MonoBehaviour
{
	...
	public void AttachToCamera(SteamVR_Camera vrcam)
	{
		...
		colorMat = new Material(UnityHelper.GetShader("SteamVR_ColorOut"));
		alphaMat = new Material(UnityHelper.GetShader("SteamVR_AlphaOut"));
		clipMaterial = new Material(UnityHelper.GetShader("SteamVR_ClearAll"));
